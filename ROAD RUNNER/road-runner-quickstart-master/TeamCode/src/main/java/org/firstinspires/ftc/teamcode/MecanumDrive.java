...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 59.0551/2459.0;
        public double lateralInPerTick = 59.0551/1916.0;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "C_0");
        leftBack = hardwareMap.get(DcMotorEx.class, "C_1");
        rightBack = hardwareMap.get(DcMotorEx.class, "EX_DT");
        rightFront = hardwareMap.get(DcMotorEx.class, "EX_DF");
//
