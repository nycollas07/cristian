...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "front_left_EX0");
        leftRear = hardwareMap.get(DcMotorEx.class, "back_left_EX1");
        rightRear = hardwareMap.get(DcMotorEx.class, "back_right_C1");
        rightFront = hardwareMap.get(DcMotorEx.class, "front_right_C0");
